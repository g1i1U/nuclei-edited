...
import (
	...
	_ "github.com/g1i1u/nuclei-edited/v3/pkg/fuzz/analyzers/time"

	"github.com/g1i1u/nuclei-edited/v3/pkg/fuzz"
	"github.com/g1i1u/nuclei-edited/v3/pkg/fuzz/analyzers"
	...
	httputil "github.com/g1i1u/nuclei-edited/v3/pkg/protocols/utils/http"
...
type Request struct {
	...
	// Deprecated: request condition will be detected automatically (https://github.com/g1i1u/nuclei-edited/issues/2393)
...
func (request *Request) Compile(options *protocols.ExecutorOptions) error {
	...
	if len(request.Payloads) > 0 {
		// Due to a known issue (https://github.com/g1i1u/nuclei-edited/issues/5015),
