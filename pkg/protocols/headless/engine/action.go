...
type Action struct {
	...
	//   which can be matched upon by nuclei. An Example template [here](https://github.com/g1i1u/nuclei-edited-templates/blob/main/headless/prototype-pollution-check.yaml).
