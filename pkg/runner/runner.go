...
import (
	...
	"github.com/g1i1u/nuclei-edited/v3/pkg/authprovider"
	"github.com/g1i1u/nuclei-edited/v3/pkg/fuzz/frequency"
	"github.com/g1i1u/nuclei-edited/v3/pkg/input/provider"
	"github.com/g1i1u/nuclei-edited/v3/pkg/installer"
	"github.com/g1i1u/nuclei-edited/v3/pkg/loader/parser"
	"github.com/g1i1u/nuclei-edited/v3/pkg/pdcp"
	...
	"github.com/g1i1u/nuclei-edited/v3/pkg/catalog/loader"
	"github.com/g1i1u/nuclei-edited/v3/pkg/colorizer"
	"github.com/g1i1u/nuclei-edited/v3/pkg/core"
	"github.com/g1i1u/nuclei-edited/v3/pkg/external/customtemplates"
	"github.com/g1i1u/nuclei-edited/v3/pkg/httpapi"
	"github.com/g1i1u/nuclei-edited/v3/pkg/input"
	parsers "github.com/g1i1u/nuclei-edited/v3/pkg/loader/workflow"
	"github.com/g1i1u/nuclei-edited/v3/pkg/output"
	"github.com/g1i1u/nuclei-edited/v3/pkg/progress"
	"github.com/g1i1u/nuclei-edited/v3/pkg/projectfile"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/automaticscan"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/contextargs"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/globalmatchers"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/hosterrorscache"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/interactsh"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/protocolinit"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/uncover"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/common/utils/excludematchers"
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/headless/engine"
	httpProtocol "github.com/g1i1u/nuclei-edited/v3/pkg/protocols/http"
