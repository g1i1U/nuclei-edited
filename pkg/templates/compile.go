...
import (
	...
	"github.com/g1i1u/nuclei-edited/v3/pkg/protocols/offlinehttp"
	"github.com/g1i1u/nuclei-edited/v3/pkg/templates/signer"
	"github.com/g1i1u/nuclei-edited/v3/pkg/tmplexec"
...
func parseTemplate(data []byte, options protocols.ExecutorOptions) (*Template, error) {
	...
	if !(template.Verified && verifier.Identifier() == "g1i1u/nuclei-edited-templates") {
