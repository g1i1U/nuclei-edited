...
<p align="center">
  <a href="https://github.com/g1i1u/nuclei-edited/blob/main/README.md">英語</a> •
  <a href="https://github.com/g1i1u/nuclei-edited/blob/main/README_CN.md">中国語</a> •
  <a href="https://github.com/g1i1u/nuclei-edited/blob/main/README_KR.md">韓国語</a> •
  <a href="https://github.com/g1i1u/nuclei-edited/blob/main/README_ID.md">インドネシア語</a> •
  <a href="https://github.com/g1i1u/nuclei-edited/blob/main/README_ES.md">スペイン語</a>
</p>
...
**300人以上の** セキュリティ研究者およびエンジニアが提供するさまざまなタイプの脆弱性テンプレートを収容する[専用リポジトリ](https://github.com/g1i1u/nuclei-edited-templates)を持っています。
...
Nucleiは、バージョン[v2.5.2](https://github.com/g1i1u/nuclei-edited/releases/tag/v2.5.2)以降、デフォルトでテンプレートの自動ダウンロード/更新をサポートしています。[**Nuclei-Templates**](https://github.com/g1i1u/nuclei-edited-templates)プロジェクトは、常に更新されるコミュニティ提供の即時使用可能なテンプレートのリストを提供します。
